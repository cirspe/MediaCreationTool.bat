...
cp -r .claude/plugins/ralph/templates/ralph ./scripts/ralph
cp .claude/plugins/ralph/templates/package.json ./package.json
cp -r .claude/plugins/ralph/scripts/src ./src
